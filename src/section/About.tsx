...
const About = () => {
  return (
    <div className="w-full py-20">
      <div className="--container w-[90%] bg-gradient-to-b from-[rgba(255,255,255,1)]  to-[rgba(255,255,255,0.5)] mx-auto flex justify-between items-center  gap-8 py-8 px-20 rounded-[20px]">
